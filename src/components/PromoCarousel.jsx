      ...
      >
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/img/carrusel-naruto.avif" className="d-block w-100" alt="Promoción figuras de anime Naruto" />
          ...
          <div className="carousel-item">
            <img
              src="/img/carrusel-shingeki.avif"
          ...
          <div className="carousel-item">
            <img src="/img/carrusel-onepiece.webp" className="d-block w-100" alt="Promoción pósters One Piece" />
            <div className="carousel-caption d-flex flex-column justify-content-center h-100">
              <div className="bg-dark bg-opacity-50 rounded p-4">
